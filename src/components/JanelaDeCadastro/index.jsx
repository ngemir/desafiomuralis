...
export default function JanelaDeCadastro() {
  ...
  function enviar(event) {
    ...
    //tratamento de nome incorreto
    let teveErro = false;

    if (nomeInserido.match(/[^A-Za-z ]+/) || nomeInserido === null) {
      let erroMSG = 'Não pode conter número ou caracteres especiais.';
      setErro({nome: erroMSG});
      teveErro = true;
    }
    ...
    <div className='janelaDeCadastro'>
      ...
      <form className='formulario' onSubmit={enviar}>
        <div className='campoDePreenchimento'>
          ...
          <input type="text" required value={ingressante.nome} name="inputNome" id="nome" onChange={(nomeInserido) => lidarInputNome(nomeInserido)} />
          {erro.nome ? <span className='msgErro'>{erro.nome}</span> : null}
        </div>
        <div className='campoDePreenchimento'>
          <label htmlFor="curso">Curso</label>
          <div className="seta">
            <select name="inputCurso" required value={ingressante.curso} id="curso" onChange={(cursoEscolhido) => lidarInputCurso(cursoEscolhido)}>
        ...
        <div className='campoDePreenchimento'>
          ...
          <div className="seta">
            <select name="inputEstado" required value={ingressante.estado} id="estado" onChange={(estadoEscolhido) => lidarInputEstado(estadoEscolhido)}>
        ...
        <div className='campoDePreenchimento'>
          ...
          <div className="seta">
            <select name="inputCidade" required value={ingressante.cidade} id="cidade" disabled={estadoNaoSelecionado} onChange={(cidadeEscolhido) => lidarInputCidade(cidadeEscolhido)}>
